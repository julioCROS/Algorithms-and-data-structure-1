...
void pontoMedio(int *vetorValores, int *vetorNaoRepetidos, int qtdeElementos, int tamNaoRepetidos){
	int i = 0;
	int j = 0;
	int posicaoFim = 0;
	int posicaoInicio = 0;
...
int main(){
	...
	*/
	...
	if(procuraResposta(lista)){
		...
		pontoMedio(vetorValores, vetorNaoRepetidos, qtdeElementos, tamNaoRepetidos);
	}
	else{
